...
bool systemPrefersDarkAppearance(const QApplication &app)
{
...
ui::Theme selectTheme(const QApplication &app)
{
    const QString requested = qEnvironmentVariable("ARTERM_THEME").trimmed().toLower();
    ...
    return systemPrefersDarkAppearance(app) ? ui::Theme::dark() : ui::Theme::light();
}
...
int main(int argc, char *argv[])
{
    ...
    parser.setApplicationDescription(
        QCoreApplication::translate("main", "SSH client and SFTP/SCP file manager"));
    ...
    ui::Theme::apply(app, selectTheme(app));
